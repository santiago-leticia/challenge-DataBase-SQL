    ...
    EXCEPTION
        ...
        WHEN NO_DATA_FOUND THEN
            ...
            values(
                ...
                SYSDATE,
                SQLCODE,
                'Dados não encontrado em vet clinica'
            );
        WHEN OTHERS THEN
            INSERT INTO LOGS (
                nm_procedure,
...
CREATE OR REPLACE PROCEDURE dados_responsavel(
    ...
    p_nm_responsavel VARCHAR2,
    p_nr_telefone_responsavel VARCHAR2
)
IS
BEGIN 
    ...
    EXCEPTION
        ...
        WHEN NO_DATA_FOUND THEN
            ...
            values(
                ...
                SYSDATE,
                SQLCODE,
                'Dato não existente em responsavel presente no banco'
            );
        WHEN OTHERS THEN
            INSERT INTO LOGS(
                nm_procedure,
    ...
    EXCEPTION
        ...
        WHEN NO_DATA_FOUND THEN
            ...
            values(
                ...
                SYSDATE,
                SQLCODE,
                'Dados não encontrado em consulta'
            );
        WHEN OTHERS THEN
            INSERT INTO LOGS(
                nm_procedure,
